          ...
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="text-right sm:border-l sm:border-border sm:pl-6">
                <span className="text-xs uppercase font-semibold text-muted-foreground block">Poin Dokumen Laporan</span>
          ...
          <form onSubmit={handleSubmitWriteup}>
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-xs">
                Pilih file dokumen investigasi tim (.pdf / .zip / .docx).
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  placeholder="Contoh: Laporan Investigasi Insiden PT XYZ - Dilengkapi PoC Exploit & Rekomendasi Mitigasi..."
                  value={notes}
            ...
            <CardFooter className="pt-2">
              ...
              >
                {uploading ? 'Mengunggah Dokumen...' : writeup ? 'Perbarui File Dokumen' : 'Kirim Laporan Writeup'}
              </Button>
            </CardFooter>
          </form>
        </Card>
